...
(({ document }) => {
  ...
  style.innerHTML = `
    ...
    .NavigationPanels-Sidebar {
      background-image: url(https://new-edu.saby.ru/tensor/new_year/2026/autumn_theme/Innokentiy_umbrella.png) !important;
      background-repeat: no-repeat !important;
      background-position-y: calc(100%) !important;
      background-position-x: calc(100% - 50%) !important;
    }
    #nav-drawer {
      background-image: url(https://new-edu.saby.ru/tensor/new_year/2026/autumn_theme/Innokentiy_umbrella.png) !important;
      background-repeat: no-repeat !important;
